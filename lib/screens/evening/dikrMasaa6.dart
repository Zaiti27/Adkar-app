...
class DikrMasaa6 extends StatefulWidget {
  const DikrMasaa6({Key? key}) : super(key: key);

  @override
  State<DikrMasaa6> createState() => _DikrMasaa6State();
}

class _DikrMasaa6State extends State<DikrMasaa6> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'أمسينا و أمسى الملك لله رب العالمين، اللهم إني أسألك خير هذه الليلة فتحها و نصرها، و نورها و بركتها، و هداها، و أعوذ بك من شر ما فيها و شر ما بعدها',
                            26,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),

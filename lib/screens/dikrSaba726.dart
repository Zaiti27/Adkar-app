...
class DikrSaba726 extends StatefulWidget {
  const DikrSaba726({Key? key}) : super(key: key);

  @override
  State<DikrSaba726> createState() => _DikrSaba726State();
}

class _DikrSaba726State extends State<DikrSaba726> {
  int _counter = 3;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'يا رب ، لك الحمد كما ينبغي لجلال و جهك، و عظيم سلطانك',
                            30,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba727(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba727(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba725(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

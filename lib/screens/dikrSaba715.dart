...
class DikrSaba715 extends StatefulWidget {
  const DikrSaba715({Key? key}) : super(key: key);

  @override
  State<DikrSaba715> createState() => _DikrSaba715State();
}

class _DikrSaba715State extends State<DikrSaba715> {
  int _counter = 3;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba716(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba716(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba714(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

...
class DikrSaba713 extends StatefulWidget {
  const DikrSaba713({Key? key}) : super(key: key);

  @override
  State<DikrSaba713> createState() => _DikrSaba713State();
}

class _DikrSaba713State extends State<DikrSaba713> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconWidget(DikrSaba712(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

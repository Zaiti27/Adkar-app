...
class DikrSaba716 extends StatefulWidget {
  const DikrSaba716({Key? key}) : super(key: key);

  @override
  State<DikrSaba716> createState() => _DikrSaba716State();
}

class _DikrSaba716State extends State<DikrSaba716> {
  int _counter = 3;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'اللهم إني أعوذ بك من الكفر و الفقر، واللهم أعوذ بك من عذاب القبر، لا إله إلا أنت',
                            30,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba717(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba717(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba715(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

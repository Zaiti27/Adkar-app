...
class DikrSaba79 extends StatefulWidget {
  const DikrSaba79({Key? key}) : super(key: key);

  @override
  State<DikrSaba79> createState() => _DikrSaba79State();
}

class _DikrSaba79State extends State<DikrSaba79> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
          ...
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'اللهم ما أصبح بي من نعمة أو بأحد من خلقك، فمنك و حدك لا شريك لك، فلك الحمد و لك الشكر',
                            30,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                ...
                IconWidget(DikrSaba78(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

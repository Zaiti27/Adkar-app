...
import 'package:flutter_application_1/screens/sleeping/dikrNaoum4.dart';
...
class DikrNaoum5 extends StatefulWidget {
  const DikrNaoum5({Key? key}) : super(key: key);

  @override
  State<DikrNaoum5> createState() => _DikrNaoum5State();
}

class _DikrNaoum5State extends State<DikrNaoum5> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'الحمد للله الذي أطعمنا و سقانا، و كفانا، و آوانا، فكم ممن لا كافي له و لا مؤوي',
                            26,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrNaoum6(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrNaoum6(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrNaoum4(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

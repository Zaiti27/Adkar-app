...
class DikrNaoum3 extends StatefulWidget {
  const DikrNaoum3({Key? key}) : super(key: key);

  @override
  State<DikrNaoum3> createState() => _DikrNaoum3State();
}

class _DikrNaoum3State extends State<DikrNaoum3> {
  int _counter = 3;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrNaoum4(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrNaoum4(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrNaoum2(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

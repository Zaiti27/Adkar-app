...
class DikrNaoum10 extends StatefulWidget {
  const DikrNaoum10({Key? key}) : super(key: key);

  @override
  State<DikrNaoum10> createState() => _DikrNaoum10State();
}

class _DikrNaoum10State extends State<DikrNaoum10> {
  int _counter = 34;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(' لله أكبر', 30, Color(0xff0c4239),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrNaoum11(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrNaoum11(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrNaoum9(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

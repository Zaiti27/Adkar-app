...
class DikrNaoum4 extends StatefulWidget {
  const DikrNaoum4({Key? key}) : super(key: key);

  @override
  State<DikrNaoum4> createState() => _DikrNaoum4State();
}

class _DikrNaoum4State extends State<DikrNaoum4> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrNaoum5(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrNaoum5(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrNaoum3(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

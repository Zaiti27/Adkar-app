...
import 'package:flutter_application_1/screens/dikrSaba728.dart';
...
class DikrSaba727 extends StatefulWidget {
  const DikrSaba727({Key? key}) : super(key: key);

  @override
  State<DikrSaba727> createState() => _DikrSaba727State();
}

class _DikrSaba727State extends State<DikrSaba727> {
  int _counter = 1;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'اللهم إني أسألك علما نافعا، و رزقا واسعا، و عملا متقبلا',
                            30,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba728(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba728(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba726(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

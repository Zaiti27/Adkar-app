...
class DikrSaba729 extends StatefulWidget {
  const DikrSaba729({Key? key}) : super(key: key);

  @override
  State<DikrSaba729> createState() => _DikrSaba729State();
}

class _DikrSaba729State extends State<DikrSaba729> {
  int _counter = 100;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba730(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba730(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba728(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

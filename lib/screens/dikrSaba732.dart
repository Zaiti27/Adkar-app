...
import 'package:flutter_application_1/screens/dikrSaba731.dart';
...
class DikrSaba732 extends StatefulWidget {
  const DikrSaba732({Key? key}) : super(key: key);

  @override
  State<DikrSaba732> createState() => _DikrSaba732State();
}

class _DikrSaba732State extends State<DikrSaba732> {
  int _counter = 100;
  void _dincrement() {
    setState(() {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconWidget(DikrSaba731(), FontAwesomeIcons.angleRight, 40,

...
class DikrSaba722 extends StatefulWidget {
  const DikrSaba722({Key? key}) : super(key: key);

  @override
  State<DikrSaba722> createState() => _DikrSaba722State();
}

class _DikrSaba722State extends State<DikrSaba722> {
  int _counter = 10;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba723(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba723(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba721(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

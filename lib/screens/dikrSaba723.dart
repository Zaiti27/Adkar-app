...
class DikrSaba723 extends StatefulWidget {
  const DikrSaba723({Key? key}) : super(key: key);

  @override
  State<DikrSaba723> createState() => _DikrSaba723State();
}

class _DikrSaba723State extends State<DikrSaba723> {
  int _counter = 3;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: CustomText(
                            'اللهم إنا نعوذ بك أن نشرك بك شيئا نعلمه، و نستغفرك لما لا نعلمه',
                            30,
                            Color(0xff0c4239),
                            FontWeight.bold,
                            TextAlign.center),
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba724(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba724(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba722(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],

...
class DikrSaba730 extends StatefulWidget {
  const DikrSaba730({Key? key}) : super(key: key);

  @override
  State<DikrSaba730> createState() => _DikrSaba730State();
}

class _DikrSaba730State extends State<DikrSaba730> {
  int _counter = 100;
  void _dincrement() {
    setState(() {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                IconWidget(DikrSaba731(), FontAwesomeIcons.angleLeft, 40,
                    Color(0xff0c4239), etat),
                GestureDetector(
                  onTap: () {
                    _dincrement();
                    if (_counter == 0)
                      changeScreenWithEtat(context, DikrSaba731(), etat);
                  },
                  child: CircleContainer(_counter),
                ),
                IconWidget(DikrSaba729(), FontAwesomeIcons.angleRight, 40,
                    Color(0xff0c4239), etat),
              ],
            ),
          ],
